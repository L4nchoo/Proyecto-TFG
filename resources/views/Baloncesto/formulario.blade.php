...
<div> 
    ...
    <div class="container py-5 text-center">
        ...
        ya insertados. -->
        @if (isset($baloncesto))
        <form action="{{ route('baloncesto.update', $baloncesto)}}" method="post"> 
            @method('PUT')      
        @else
        <form action="{{ route('baloncesto.store')}}" method="post">            
        @endif
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nombre" class="form-control" placeholder="Nombre y apellido del jugador" value="{{old('nombre') ??  @$baloncesto->nombre}}">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="edad" class="form-control" placeholder="Edad del jugador" value="{{old('edad') ??  @$baloncesto->edad}}">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nacionalidad" class="form-control" placeholder="Nacionalidad del jugador" value="{{old('nacionalidad') ??  @$baloncesto->nacionalidad}}">
            ...
            <div class="mb-3">
                <label for="nacionalidad" class="form-label">Equipo</label>                                             
                <select type="text" name="equipo" class="form-control" placeholder="Equipo del jugador" value="">
                    <option value=""></option>
                    <option value="Real Madrid">Real Madrid</option>
                    <option  value="Rayo Vallecano">Estudiantes</option>
                    <option  value="Leganes">Leganes</option>
                </select>
                <p class="form-text">Selecione el equipo del jugador</p>
                @error('equipo')                    
                <p class="form-text text-danger">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="dorsal" class="form-control" placeholder="Dorsal del jugador" value="{{old('dorsal') ??  @$baloncesto->dorsal}}">
        ...
        <!-- Este es el boton para volver a la pagina anterior, en este caso para ver los datos de los jugadores que hay registrados en el baloncesto. -->
        <a href="{{ route('baloncesto.index')}}" class="btn btn-outline-secondary btn-lg">Volver</a>
