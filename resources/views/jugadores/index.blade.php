...
@section('content')
    ...
    <!-- Este div contiene el listado de jugadores que jugan al futbol -->
    <div class="container py-5 text-center">
        ...
        <table class="table">
            ...
            <br/>
            <tbody>
                <!-- Con este forelse, lo que hacemos es rellenar los datos de la tabla futbol -->
                ...
                <tr>                 
                    ...
                    <td>
                        ...
                        <a href="{{ route('jugador.edit',$detail)}}" disable class="btn btn-warning btn-sm">EDITAR</a>
                        <form action="{{ route('jugador.destroy',$detail)}}" method="post" class="d-inline">
                            @method('DELETE')
                            @csrf
