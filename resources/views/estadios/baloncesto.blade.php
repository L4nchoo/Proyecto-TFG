...
@section('content')
  ...
  <div class="container">
    ...
    <div id="Rayo">
      <h4 class="container py-3 text-center">ESTUDIANTES</h4>
      <div id = "Rayo1"></div>
      <div id = "Rayo2"></div>
      <div id = "Rayo3"></div>
    </div>
  ...
  <style type="text/css">
    #RealMadrid {        
      ...
      #RealMadrid1{        
        ...
        margin-top: 30px;
        margin-left: 25px;
        background-image: url('img/baloncesto/BaloncestoRealMadrid1.png');
      ...
      #RealMadrid2{        
        ...
        margin-top: -452px;
        margin-left: 675px;
        background-image: url('img/baloncesto/BaloncestoRealMadrid2.png');
        background-size : cover;
      }   
      #RealMadrid3{        
        height: 452px;
        ...
        margin-top: 25px;
        margin-left: 350px;
        background-image: url('img//baloncesto/BaloncestoRealMadrid3.png');
        background-size : cover;
      }
      #Rayo{          
      height: 1050px;
      ...
      #Rayo1{        
        ...
        margin-top: 30px;
        margin-left: 25px;
        background-image: url('img/baloncesto/BaloncestoEstudiantes1.png');
        background-size : cover;
      }   
      #Rayo2{        
        height: 452px;
        ...
        margin-top: -452px;
        margin-left: 675px;
        background-image: url('img/baloncesto/BaloncestoEstudiantes2.png');
        background-size : cover;
      }   
      #Rayo3{        
        height: 452px;
        ...
        margin-top: 25px;
        margin-left: 350px;
        background-image: url('img/baloncesto/BaloncestoEstudiantes3.png');
        background-size : cover;
      }
      #Leganes{          
      height: 1050px;
      ...
      #Leganes1{        
        ...
        margin-top: 30px;
        margin-left: 25px;
        background-image: url('img/baloncesto/BaloncestoLeganes1.png');
        background-size : cover;
      }   
      #Leganes2{        
        height: 452px;
        ...
        margin-top: -452px;
        margin-left: 675px;
        background-image: url('img/baloncesto/BaloncestoLeganes2.png');
        background-size : cover;
      }   
      #Leganes3{        
        height: 452px;
        ...
        margin-top: 25px;
        margin-left: 350px;
        background-image: url('img/baloncesto/BaloncestoLeganes3.png');
        background-size : cover;
      }
    #volver{
      height: 50px;
